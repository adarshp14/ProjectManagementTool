...
import com.project.management.domain.ProjectTask;
import com.project.management.services.MapValidationErrorService;
import com.project.management.services.ProjectTaskService;
...
public class BacklogController {
  ...
  public ResponseEntity<?> getProjectTask(
    ...
    ProjectTask projectTask =
        projectTaskService.findPTByProjectSequence(backlog_id, pt_id, principal.getName());
  ...
  public ResponseEntity<?> deleteProjectTask(
    ...
    return new ResponseEntity<String>(
        "Project Task " + pt_id + " was deleted successfully", HttpStatus.OK);
  }
}
